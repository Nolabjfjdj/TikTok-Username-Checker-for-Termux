...
import os, time, requests, cloudscraper, ctypes, string, random, shutil, platform, threading
...
class TiktokUsernameChecker:
    ...
    def WriteOrRead(file, mode):
        f = open(os.path.join(TiktokUsernameChecker.directory, "output", file), mode)
        return f
